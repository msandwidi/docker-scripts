...
echo "3 - pull and run portainer commuity edition container"
...
install() {
    ...
    #Stack template url
    STACK_TEMPLATE_URL="https://raw.githubusercontent.com/msandwidi/docker-scripts/main/compose/portainer-ce%2Bnginx-proxy-manager.yml"
